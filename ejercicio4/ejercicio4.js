let operandoA = parseInt(prompt("Introduce un operando:"));
let operandoB = parseInt(prompt("Introduce el segundo operando:"));
let operador = prompt("Introduce el signo del operador ('+', '-', '*', '/', 'FIN'):");
let resultado = 0;
